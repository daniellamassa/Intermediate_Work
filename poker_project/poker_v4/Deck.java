...
public class Deck {
    private static final int CARD_RANK_MIN = 2;
    private static final int CARD_RANK_MAX = 14;
    private static final int CARD_SUIT_MIN = 0;
    private static final int CARD_SUIT_MAX = 3;
    ...
    public Deck() {
        ...
        for (int rank = CARD_RANK_MIN; rank <= CARD_RANK_MAX; rank++){
            for (int suit = CARD_SUIT_MIN; suit <= CARD_SUIT_MAX; suit++){
